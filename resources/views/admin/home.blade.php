									...
									<div class="card-header pb-0 flex-wrap border-0">
										...
										<div class="card-tabs mb-3">
											<ul class="nav nav-tabs" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-toggle="tab" href="index-2.html#Monthly" role="tab">
														Monthly	
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link " data-toggle="tab" href="index-2.html#Weekly" role="tab">
														Weekly
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="index-2.html#Today" role="tab">
														Today
													</a>
												</li>
											</ul>
